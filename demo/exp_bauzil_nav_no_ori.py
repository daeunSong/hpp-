...
afftool.loadObstacleModel ("package://hpp_environments/urdf/multicontact/bauzil_stairs.urdf", "planning", vf,reduceSizes=[0.07,0.,0.])
...
cs.saveAsBinary("talos_bauzil_no_ori.cs")
